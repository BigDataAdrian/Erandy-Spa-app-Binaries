document.addEventListener("DOMContentLoaded", () => {
    setActiveMenu("BranchesModule", "BranchesModuleSingleBlockings");
    LoadBranches();
    LoadReasons();
...
async function LoadSingleBlockings() {
    ...
    try {
        const response = await fetch(`/Branches/GetSingleBlockingsTable?BranchId=${Branch.value}`, {
            method: "GET",
            headers: {
                "Content-Type": "application/json"
            }
...
async function AddBlocking() {
    try {
        ...
        const response = await fetch("/Branches/AddBlocking", {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
async function UpdateBlockingModalOpen(BlockingId) {
    try {
        const response = await fetch(`/Branches/GetSingleBlocking?BlockingId=${BlockingId}`, {
            method: "GET",
            headers: {
                "Content-Type": "application/json"
            }
...
async function UpdateBlocking() {
    try {
        ...
        const response = await fetch("/Branches/UpdateBlocking", {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
async function DeleteSingleBlocking() {
    try {
        ...
        const response = await fetch("/Branches/DeleteSingleBlocking?BlockingId=" + Blocking, {
            method: "DELETE"
        });
