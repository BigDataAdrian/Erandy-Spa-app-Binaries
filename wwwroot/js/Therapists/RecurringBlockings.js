document.addEventListener("DOMContentLoaded", () => {
    setActiveMenu("TherapistsModule", "TherapistsModuleRecurringBlockings");
    LoadTherapists();
    LoadReasons();
...
async function LoadRecurringBlockings() {
    const Room = document.getElementById("therapistSelect");
    document.getElementById('CardBlockings').style.display = "flex";
    try {
        const response = await fetch(`/Therapists/GetRecurringBlockingsTable?TherapistId=${Room.value}`, {
            method: "GET",
            headers: {
                "Content-Type": "application/json"
            }
...
async function AddBlocking() {
    try {
        const Therapist = document.getElementById("therapistSelect");
        ...
        const response = await fetch("/Therapists/AddRecurringBlocking", {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
async function UpdateBlockingModalOpen(BlockingId) {
    try {
        const response = await fetch(`/Therapists/GetRecurringBlocking?BlockingId=${BlockingId}`, {
            method: "GET",
...
async function UpdateBlocking() {
    try {
        ...
        const response = await fetch("/Therapists/UpdateRecurringBlocking", {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
async function DeleteRecurringBlocking() {
    try {
        ...
        const response = await fetch("/Therapists/DeleteRecurringBlocking?BlockingId=" + Blocking, {
            method: "DELETE"
        });
