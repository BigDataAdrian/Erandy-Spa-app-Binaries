document.addEventListener("DOMContentLoaded", () => {
    setActiveMenu("RoomsModule", "RoomsModuleRecurringBlockings");
    LoadRooms();
    LoadReasons();
...
async function LoadRecurringBlockings() {
    ...
    try {
        const response = await fetch(`/Rooms/GetRecurringBlockingsTable?RoomId=${Room.value}`, {
            method: "GET",
            headers: {
                "Content-Type": "application/json"
            }
...
async function AddBlocking() {
    try {
        ...
        const response = await fetch("/Rooms/AddRecurringBlocking", {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
async function UpdateBlockingModalOpen(BlockingId) {
    try {
        const response = await fetch(`/Rooms/GetRecurringBlocking?BlockingId=${BlockingId}`, {
            method: "GET",
...
async function UpdateBlocking() {
    try {
        ...
        const response = await fetch("/Rooms/UpdateRecurringBlocking", {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
async function DeleteRecurringBlocking() {
    try {
        ...
        const response = await fetch("/Rooms/DeleteRecurringBlocking?BlockingId=" + Blocking, {
            method: "DELETE"
        });
