...
async function LoadCategories() {
    try {
        const response = await fetch(`/Protocols/GetCategories`, {
            method: "GET",
            headers: {
...
async function DeleteCategory() {
    try {
        ...
        const response = await fetch("/Protocols/DeleteCategory", {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
async function AddCategory() {
    try {
        ...
        const response = await fetch("/Protocols/AddCategory", {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
async function UpdateCategory() {
    try {
        ...
        const response = await fetch("/Protocols/UpdateCategory", {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
